 ...
 */
class StringsArraysAlgorithmsTest {
    ...
    void testString(){
        ...
        /*
            ...
            All spaces that are aligned vertically from ending """ or the left most non-blank character are included in the text block
    ...
    void testArraysMethod(){
        ...
        /*
            ...
            Multiple element with same value : Can return index of any element with same value.
            Element not found : return -ve index (Corresponding +ve index - 1 would be its insertion point in sorted array)
